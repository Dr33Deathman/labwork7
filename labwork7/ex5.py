...
for point in range(0,641,64): # range(start, stop, step)
    pygame.draw.line(background, (228,0,228), (0,0), (screenSize[0]//2, point), 1)
    # from left top corner 
for point in range(0,641,64):
    pygame.draw.line(background, (228,0,228), (screenSize[0],0), (screenSize[0]//2, point), 1)
    # from right top corner
for point in range(0,641,64): 
    pygame.draw.line(background, (228,0,228), (0,screenSize[1]), (screenSize[0]//2, point), 1)
    # from left bot corner
for point in range(0,641,64): 
    pygame.draw.line(background, (228,0,228), (screenSize[0],screenSize[1]), (screenSize[0]//2, point), 1)
    # from right bot corner

screen.blit(background, (0, 0))  # draw on screen our background with pretty pattern
