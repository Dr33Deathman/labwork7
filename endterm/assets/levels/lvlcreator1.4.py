...
# Select DB
client = pymongo.MongoClient("mongodb+srv://Editor:edit@cluster0-mhy2m.mongodb.net/test?retryWrites=true&w=majority")
db = client['TonksDB']
col = db['Levels']
...
while not done:
    ...
    for i in range(4):
        ...
        if((660+40*(i%2) <= mp[0] <= 690+40*(i%2)) and (40+40*(i//2) <= mp[1] <= 70+40*(i//2))):
