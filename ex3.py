...
angle = 360 / 5  # angle for 1 vertice
radius = round(screenSize[1]/2)  # radius of pentagram
coords = [(round(screenSize[0]/2 + radius*math.cos(math.radians(90+n*angle))),
           round(screenSize[1]/2 - 20 + radius*math.sin(math.radians(90+n*angle)))) for n in range(5)]
...
for i in a:  # Draw all permutations
    for j in range(1, len(i)):
        pygame.draw.line(background, (255, 255, 255), i[j-1], i[j], 1)
